            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/apartment/update" method="get" class="form-horizontal" />
                        <div class="control-group">
                            <label class="control-label">公寓编号</label>
                            <div class="controls">
                                <input type="text" name="apartmentid" id="evarecordid" value="${apartment.apartmentid}" readonly="readonly" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="fee" value="${apartment.fee}" >
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">最大可容纳人数</label>
                            <div class="controls">
                                <input type="text" name="maxoccupancy" value="${apartment.maxoccupancy}">
