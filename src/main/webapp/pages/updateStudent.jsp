            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/student/update" method="get" class="form-horizontal" />
                        ...
                        <div class="control-group">
                            ...
                            <input type="password" name="stupassword" value="${student.stupassword}">
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="gender" value="${student.gender}">
                                    <option  value="男" <c:if test="${student.gender eq '男'}">selected</c:if>>男</option>
                                    <option  value="女" <c:if test="${student.gender eq '女'}">selected</c:if>>女</option>
                                </select>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="dormid" id="dormid">
                                    <option value="${student.dormid}" selected="selected">${student.dormid}</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">学院</label>
                            <input type="text" value="${student.college}" name="college">
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <input type="text" value="${student.telephone}" name="telephone" id="telephone">
                        </div>
